    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            */
            ...
            Console.WriteLine($"Capicity: {numbersList.Capacity}");
        ...
        private static void NumberChecker(List<int> numberList, int searchNumber)
        {
            bool found = false;
                ...
                if (found)
                {
                    Console.WriteLine($"Your guess {searchNumber} was in the list");
                }
                else
                {
                    Console.WriteLine($"Your guess {searchNumber} was not in the list");
                }
